...
@section('content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Input Pengguna</h5>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="email" name="email"
                                ...
                                id="email" value="{{ $user->email }}" aria-describedby="email">
                            @error('email')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <select name="roles[]"
                                class="form-control {{ $errors->has('roles') ? 'border border-danger' : '' }}"
                                id="roles" aria-describedby="roles" multiple>
                                <option value="">Pilih Role</option>
                                @foreach ($roles as $role)
                                    <option value="{{ $role->id }}"
                                        {{ in_array($role->id, $roles->pluck('id')->toArray()) ? 'selected' : '' }}>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="password" name="password"
                                ...
                                id="password" value="" aria-describedby="password">
                            @error('password')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
