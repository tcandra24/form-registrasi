    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('/shifts') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" id="shiftName" aria-describedby="name">
            </div>
            <div class="mb-3">
                <label for="siftStart" class="form-label">Awal</label>
                <input type="text" name="start" class="form-control" id="siftStart" aria-describedby="start">
            </div>
            <div class="mb-3">
                <label for="siftEnd" class="form-label">Akhir</label>
                <input type="text" name="end" class="form-control" id="siftEnd" aria-describedby="end">
            </div>
            <div class="mb-3">
                <label for="shiftQuota" class="form-label">Kuota</label>
                <input type="text" name="quota" class="form-control" id="shiftQuota" aria-describedby="quota">
            </div>
