...
<div class="card">
    <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Input Shift</h5>
            ...
            <div class="row">
                <div class="col-lg-6 d-flex align-items-stretch">
                    <div class="mb-3 w-100">
                        ...
                        <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'border border-danger' : '' }}" value="{{ old('name') }}" id="shiftName" aria-describedby="name">
                        @error('name')
                ...
                <div class="col-lg-6 d-flex align-items-stretch">
                    <div class="mb-3 w-100">
                        ...
                        <input type="text" name="quota" class="form-control {{ $errors->has('quota') ? 'border border-danger' : '' }}" value="{{ old('quota') }}" id="shiftQuota" aria-describedby="quota">
                        @error('quota')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 d-flex align-items-stretch">
                    <div class="mb-3 w-100">
                        ...
                        <input type="text" name="start" class="form-control {{ $errors->has('start') ? 'border border-danger' : '' }}" value="{{ old('start') }}" id="siftStart" aria-describedby="start">
                        @error('start')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-lg-6 d-flex align-items-stretch">
                    <div class="mb-3 w-100">
                        ...
                        <input type="text" name="end" class="form-control {{ $errors->has('end') ? 'border border-danger' : '' }}" value="{{ old('end') }}" id="siftEnd" aria-describedby="end">
                        @error('end')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
