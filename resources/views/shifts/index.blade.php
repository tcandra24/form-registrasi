                                    ...
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="/shifts/{{ $shift->id }}/edit" class="btn btn-success m-1">Edit</a>
                                                <button class="btn btn-danger m-1 btn-delete" data-id="{{ $shift->id }}" data-name="{{ $shift->name }}">Delete</button>

                                                <form id="form-delete-shift-{{ $shift->id }}" method="POST" action=" {{ url('/shifts/' . $shift->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
