                ...
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        <form id="form-delete-not-scan" method="POST"
                            action="{{ url('/transactions/registration-mechanics/' . request()->event . '/delete-not-scan') }}">
                            @csrf
                            @method('DELETE')
                        </form>
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-3">
                            <a href="/trash/registration-mechanics/{{ request()->event }}"
                                class="btn btn-primary">Sampah</a>
                        </div>
                    </div>
                    <div class="row">
