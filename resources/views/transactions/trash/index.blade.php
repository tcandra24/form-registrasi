    ...
    <div class="col-lg-12 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-body p-4">
                ...
                <div class="row">
                    <form action="{{ url('/transactions/trash') }}">
                        <div class="row">
                ...
                <div class="row">
                    <form action="{{ url('/transactions/trash/export') }}">
                                ...
                                @if(count($registrations) > 0)
                                    @foreach($registrations AS $registration)
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <div class="d-flex align-items-center gap-2">
                                                    <button class="btn btn-secondary m-1 btn-restore" data-url="/transactions/trash/restore/{{ $registration->id }}" data-name="{{ $registration->fullname }}">Pulihkan</button>
                                                    <button class="btn btn-danger m-1 btn-delete" data-url="/transactions/trash/delete/{{ $registration->id }}" data-name="{{ $registration->fullname }}">Hapus</button>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
