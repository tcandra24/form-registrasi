        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    ...
                    <h5 class="card-title fw-semibold mb-4">Transaksi Sampah Registrasi</h5>
                    <div class="row mb-3">
                        <form action="{{ route('transaction.trash.show', $event) }}">
                            <div class="row">
                                <div class="col-lg-2 d-flex align-items-stretch">
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-bottom-0 pb-0">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <form id="form-restore-registration-{{ $registration->id }}"
                                                            method="POST"
                                                            action=" {{ route('transaction.trash.restore', ['event_id' => $event, 'registration_number' => $registration->registration_number]) }}">
                                                            @csrf
                                                        </form>
                                                    </div>
                                                </td>
        ...
        $('.btn-restore').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $('#form-restore-registration-' + id).submit()
                }
            })
