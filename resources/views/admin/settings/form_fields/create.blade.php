...
@section('content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Input Form Field</h5>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" name="label"
                                ...
                                id="FieldLabel" aria-describedby="label">
                            @error('label')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" name="model_path"
                                ...
                                id="FieldModel" aria-describedby="model_path">
                            @error('model_path')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" name="relation_method_name"
                                ...
                                id="FieldRelation" aria-describedby="relation_method_name">
