                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" name="name"
                                class="form-control {{ $errors->has('name') ? 'border border-danger' : '' }}" id="shiftName"
                                value="{{ $shift->name }}" aria-describedby="name">
                            @error('name')
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" name="quota"
                                ...
                                id="shiftQuota" value="{{ $shift->quota }}" aria-describedby="quota">
                            @error('quota')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" name="start"
                                class="form-control {{ $errors->has('start') ? 'border border-danger' : '' }}"
                                id="siftStart" value="{{ $shift->start }}" aria-describedby="start">
                            @error('start')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" name="end"
                                class="form-control {{ $errors->has('end') ? 'border border-danger' : '' }}" id="siftEnd"
                                value="{{ $shift->end }}" aria-describedby="end">
                            @error('end')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                            ...
                            <select name="event_id"
                                ...
                                @foreach ($events as $event)
                                    <option value="{{ $event->id }}"
                                        {{ $shift->event->id === $event->id ? 'selected' : '' }}>
                                        {{ $event->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3 w-100">
                            <div class="form-check">
                                <input class="form-check-input" name="active" type="checkbox" id="active"
                                    aria-describedby="active" {{ $shift->is_active ? 'checked' : '' }}>
