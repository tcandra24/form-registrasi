                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" name="start"
                                ...
                                value="{{ old('start') }}" id="siftStart" aria-describedby="start">
                            @error('start')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" name="end"
                                class="form-control {{ $errors->has('end') ? 'border border-danger' : '' }}"
                                value="{{ old('end') }}" id="siftEnd" aria-describedby="end">
                            @error('end')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
