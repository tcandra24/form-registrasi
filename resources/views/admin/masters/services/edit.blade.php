                    ...
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <input type="text" name="name"
                                ...
                                id="serviceName" value="{{ $service->name }}" aria-describedby="name">
                            @error('name')
                ...
                <div class="row">
                    <div class="col-lg-6 d-flex align-items-stretch">
                        <div class="mb-3 w-100">
                            ...
                            <textarea class="form-control {{ $errors->has('description') ? 'border border-danger' : '' }}" name="description"
                                id="serviceDesc" aria-describedby="description" cols="10" rows="10">
                            {{ $service->description }}
                        </textarea>
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="mb-3 w-100">
                            <div class="form-check">
                                <input class="form-check-input" name="active" type="checkbox" id="active"
                                    aria-describedby="active" {{ $service->is_active ? 'checked' : '' }}>
