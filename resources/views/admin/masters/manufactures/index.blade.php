            ...
            <div class="card w-100">
                <div class="card-body p-4">
                    ...
                    @can('master.manufactures.create')
                        <a href="{{ route('manufactures.create') }}" class="btn btn-primary m-1">Tambah</a>
                    @endcan
                                    ...
                                    @foreach ($manufactures as $key => $manufacture)
                                        <tr>
                                            <td class="border-bottom-0 pb-0">
                                                <h6 class="fw-semibold mb-0">{{ $manufactures->firstItem() + $key }}</h6>
                                            </td>
                                            <td class="border-bottom-0 pb-0">
                                            ...
                                            <td class="border-bottom-0 pb-0">
                                                <div class="d-flex align-items-center gap-2">
                                                    @can('master.manufactures.edit')
                                                        <a href="{{ route('manufactures.edit', $manufacture->id) }}"
                                                    ...
                                                    @can('master.manufactures.delete')
                                                        ...
                                                        <form id="form-delete-manufacture-{{ $manufacture->id }}" method="POST"
                                                            action=" {{ route('manufactures.destroy', $manufacture->id) }}">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                    @endcan
