        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    ...
                    @can('master.events.create')
                        <a href="{{ route('events.create') }}" class="btn btn-primary m-1">Tambah</a>
                    @endcan
                                                ...
                                                <div class="row">
                                                    <div class="d-flex align-items-center gap-2 flex-wrap"
                                                        ...
                                                        @foreach ($event->forms as $form)
                                                            <span
                                                                class="badge bg-success rounded-3 fw-semibold">{{ $form->name }}</span>
                                                        @endforeach
                                                    </div>
                                                </div>
                                            </td>
